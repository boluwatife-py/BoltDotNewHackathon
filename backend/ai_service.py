"""
AI Service module for SafeDoser backend
Integrates with Google Gemini AI for medical assistance
"""
...
class AIService:
    ...
    async def _generate_gemini_response(
        ...
        try:
            # Build the prompt with medical knowledge and context
    ...
    def _build_medical_prompt(
        ...
        """Build comprehensive medical prompt for AI"""
        
        # Medical knowledge base prompt
        medical_prompt = """
...
"""
    ...
    def _generate_interaction_response(self, supplements: List[Dict], user_name: str) -> str:
    ...
    def _generate_timing_response(self, supplements: List[Dict], user_name: str) -> str:
