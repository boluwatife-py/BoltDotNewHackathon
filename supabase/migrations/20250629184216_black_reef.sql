...
BEGIN
    ...
    IF NOT EXISTS (
        ...
        WHERE tablename = 'supplement_logs' 
        AND policyname = 'Users can view own supplement logs'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'supplement_logs' 
        AND policyname = 'Users can insert own supplement logs'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'supplement_logs' 
        AND policyname = 'Users can update own supplement logs'
    ) THEN
    ...
    IF NOT EXISTS (
        SELECT 1 FROM pg_policies 
        WHERE tablename = 'supplement_logs' 
        AND policyname = 'Users can delete own supplement logs'
    ) THEN
