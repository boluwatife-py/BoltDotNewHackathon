  ...
  return (
    <div className="py-[1rem] flex items-end gap-2 self-end max-w-[22.5rem] min-h-[2.8125rem] animate-[popin_0.3s_ease-out]">
      <div className="flex gap-[0.75rem]">
        <div className="flex flex-col gap-[0.25rem] justify-end">
          <span className="font-medium text-[#6B7280] text-[0.875rem] self-end">
            {name}
          </span>
          <div className="bg-[var(--primary-color)] border border-[#CCC] pr-[1rem] pl-[0.75rem] py-[0.75rem] rounded-[1.25rem] rounded-tr text-white text-[1.0625rem] leading-snug w-fit max-w-[22.5rem] min-h-[2.5rem] flex items-center self-end">
            {isLoading ? (
