...
- When guiding the user to perform an action, refer to the relevant app section or button (e.g., "Go to the 'Scan' tab," "Click the '+' button," "Check 'My Supplement Lists' in 'Settings'").
