    ...
    <div className="bg-[var(--border-dark)] min-h-[calc(100vh-60px)]">
      ...
      <div className="p-4">
        ...
        <div className="px-[var(--lg)] py-[var(--slg)] text-center">
          <h1 className="text-[28px] font-bold text-[var(--text-primary)] tracking-[-0.5px] flex justify-center">
            Today, <span className="block text-[12px] font-medium">{formattedDate}</span>
          </h1>
        </div>
